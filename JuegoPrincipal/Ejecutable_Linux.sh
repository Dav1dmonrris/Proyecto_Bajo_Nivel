...
rm -f main.o ObjetoRectangulo.o Movimiento.o Enemigo.o Meta.o 
...
g++ -c ./Clases/Meta.cpp -o Meta.o
#g++ -c ./Clases/Administrador_Enemigos.cpp -o AdministradorEnemigos.o

# Enlazar TODOS los archivos objeto juntos
g++ main.o ObjetoRectangulo.o Movimiento.o Enemigo.o Meta.o -o Juego -lsfml-graphics -lsfml-window -lsfml-system
